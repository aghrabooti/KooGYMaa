...
function time(date: Date) {
  return new Intl.DateTimeFormat("fa-IR", { hour: "numeric", minute: "2-digit" }).format(date);
}
    ...
    <div className="trainer-page">
      ...
      <div className="trainer-dashboard-grid">
        <section className="trainer-panel trainer-agenda">
          <div className="trainer-panel__heading"><div><h2>جلسات آینده</h2><p>هفت روز آینده شما</p></div><Link href="/trainer/schedule">برنامه کامل <Icon name="arrow" size={14} /></Link></div>
